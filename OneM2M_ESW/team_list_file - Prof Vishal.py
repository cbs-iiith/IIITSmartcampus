team_list = \
		{
			...
			4  :  
				{ 
					...
					'nodes' : ['MEET_TA_ASAP'], #container
					'project_description' : 'abc', #container
					'node_description' : 'node_1:(turbidity,photo_electric_fluid_level)', #container
			...
			5  :  
				{ 
					...
					'nodes' : ['node_1'], #container
					'project_description' : 'abc', #container
					'node_description' : 'node_1:(ultrasonic_sensor)', #container
					'labels' : '<labels>,audio,indoor,classroom' #labels
				},
			6  :  
				{ 
					'title' : 'Outdoor_air_pollution-2',
			...
			11  :  
				{ 
					...
					'project_description' : 'abc', #container
					'node_description' : 'node_1:(),node_2:(),node_3:(),node_4:()', #container
					'labels' : '<labels>' #labels
				},
			12  :  
				{ 
			...
			37  :  
				{ 
					'title' : 'Indoor_Air_Pollution-1_Mess',
          			'num_of_nodes' : '1', #container
					'nodes' : ['MEET_TA_ASAP'], #container
					'project_description' : 'abc', #container
					'node_description' : 'node_1:()', #container
