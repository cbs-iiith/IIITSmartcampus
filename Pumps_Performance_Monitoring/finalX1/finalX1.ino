...
String pushCurrent = "NULL-Value";
String pushVoltage = "NULL-Value";
String pushPower = "NULL-Value";
String pushTemp = "NULL-Value";
String pushRH = "NULL-Value";
String pushFlow = "NULL-Value";
...
//char* wifi_ssid = "Realme 1";
char* wifi_pwd = "e5W-eMai@3!20hOct";
//char* wifi_pwd = "itis@pass";
char* wifi_ssid2="";
char* wifi_pwd2="";
